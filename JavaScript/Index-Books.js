...
//Top Categories
class TopCategories extends HTMLElement {
  connectedCallback() {
    this.innerHTML = `
        <div class="Slider">
          <!-- Adventure -->
          <div class="Card">
            <a href="/Category/Adventure.html">
              <img
                src="/Images/Category-IMG/Adventure.webp"
                alt="Adventure"
              />
            </a>
          </div>
          ...
          <div class="Card">
            <a href="/Category/Fiction.html">
              <img
                src="/Images/Category-IMG/Fiction.webp"
                alt="Fiction"
              />
            </a>
          </div>
          ...
          <div class="Card">
            <a href="/Category/Romance.html">
              <img
                src="/Images/Category-IMG/Romance.webp"
                alt="Romance"
              />
            </a>
          </div>
          ...
          <div class="Card">
            <a href="/Category/Thriller.html">
              <img
                src="/Images/Category-IMG/Thriller.webp"
                alt="Thriller"
              />
            </a>
          </div>
...
customElements.define("import-top-categories", TopCategories);
