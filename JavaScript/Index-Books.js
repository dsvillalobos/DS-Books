            ...
            <div class="Slider">
                ...
                <div class="Card scale-in-center">
                    <a href="/Category/Adventure.html">
                        <img src="/Images/Category-IMG/Adventure.webp" alt="Adventure" loading="lazy" />
                    </a>
                </div>
                <!-- Fiction -->
                <div class="Card scale-in-center">
                    <a href="/Category/Fiction.html">
                        <img src="/Images/Category-IMG/Fiction.webp" alt="Fiction" loading="lazy" />
                    </a>
                </div>
                <!-- Romance -->
                <div class="Card scale-in-center">
                    <a href="/Category/Romance.html">
                        <img src="/Images/Category-IMG/Romance.webp" alt="Romance" loading="lazy" />
                    </a>
                </div>
                <!-- Thriller -->
                <div class="Card scale-in-center">
                    <a href="/Category/Thriller.html">
                        <img src="/Images/Category-IMG/Thriller.webp" alt="Thriller" loading="lazy" />
                    </a>
                </div>
            </div>
        `;
...
customElements.define("import-top-categories-slider", TopCategoriesSlider);
