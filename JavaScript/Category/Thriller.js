...
function _112263() {
    ...
    if (/android/i.test(OS)) {
        ReadButton.setAttribute("href", "https://drive.google.com/file/d/1AGiD-F5YMLt_mIPiho4CelvMVOZNlci8/view?usp=sharing");
    }
}
...
function CrimeandPunishment() {
    ...
    if (/android/i.test(OS)) {
        ReadButton.setAttribute("href", "https://drive.google.com/file/d/1-quBqLAUzr2UaVeHYa7986ivDRzYYRoN/view?usp=sharing");
    }
}
...
function DarkMatter() {
    ...
    if (/android/i.test(OS)) {
        ReadButton.setAttribute("href", "https://drive.google.com/file/d/19bo7ZzPjaZ055IHCxIuxKEt8ikhIhJTj/view?usp=sharing");
    }
}
...
function Misery() {
    ...
    if (/android/i.test(OS)) {
        ReadButton.setAttribute("href", "https://drive.google.com/file/d/1b1fdzh0n2LFi-DhD2vrKeC1-JewnxT_D/view?usp=sharing");
    }
}
...
function StrangersonaTrain() {
    ...
    if (/android/i.test(OS)) {
        ReadButton.setAttribute("href", "https://drive.google.com/file/d/1Yj4ofQyL4tqMXk7PDMj2FRQ6UnIox37y/view?usp=sharing");
    }
}
...
function HelterSkelter() {
    ...
    if (/android/i.test(OS)) {
        ReadButton.setAttribute("href", "https://drive.google.com/file/d/17drdwbOYrz1fSi2xILJW0rYpWPC865UD/view?usp=sharing");
    }
}
