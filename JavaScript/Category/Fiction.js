...
function TheInvisibleMan() {
  ...
  if (/android/i.test(OS)) {
    ReadButton.setAttribute(
      "href",
      "https://drive.google.com/file/d/1kc8EnMKMEQQ8ARE74NHl3USDGOkVTLj6/view?usp=sharing"
    );
  }
}
...
function Fahrenheit451() {
  ...
  if (/android/i.test(OS)) {
    ReadButton.setAttribute(
      "href",
      "https://drive.google.com/file/d/1kBUnFc-CTxgHODZMZ3f6C__PUVczpWxC/view?usp=sharing"
    );
  }
}
...
function TheMartian() {
  ...
  if (/android/i.test(OS)) {
    ReadButton.setAttribute(
      "href",
      "https://drive.google.com/file/d/1pFexoYN0ZOdp74EEjG_8LyN7eSs0xZXh/view?usp=sharing"
    );
  }
}
